...
import { Factory, TrendingUp, Users, Wrench, Activity, Zap } from 'lucide-react'
  ...
  const dashboardRoles = [
    {
      ...
      description: 'High-level KPI metrics and operational overview for C-suite decision-making',
      icon: TrendingUp,
    ...
    },
    {
      ...
      description: 'Comprehensive operational visibility with real-time machine monitoring',
      icon: Factory,
    ...
    },
    {
      ...
      description: 'Production planning, scheduling optimization, and status monitoring',
      icon: Activity,
    ...
    },
    {
      ...
      description: 'Equipment health diagnostics, maintenance schedules, and predictive alerts',
      icon: Wrench,
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 dark:from-slate-900 dark:to-slate-800">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h1 className="text-2xl font-bold text-gray-900 dark:text-white">UNS Demo System</h1>
                <p className="text-sm text-gray-600 dark:text-gray-300">Unified Namespace for Smart Manufacturing</p>
              </div>
            </div>
              ...
              {loading ? (
                ...
                <div className="flex items-center space-x-2">
                  <div className={`h-3 w-3 rounded-full ${
                    systemStatus?.pipeline.isHealthy ? 'bg-green-500' : 'bg-red-500'
                  }`}></div>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          {loading ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
              <div className="bg-white dark:bg-slate-800 rounded-lg p-6 shadow-sm">
                ...
                <p className="text-2xl font-bold text-gray-900 dark:text-white">{systemStatus?.machines.total || 0}</p>
              </div>
              <div className="bg-white dark:bg-slate-800 rounded-lg p-6 shadow-sm">
                <p className="text-sm font-medium text-gray-600 dark:text-gray-400">Connected</p>
                <p className="text-2xl font-bold text-green-600">{systemStatus?.machines.connected || 0}</p>
              </div>
              <div className="bg-white dark:bg-slate-800 rounded-lg p-6 shadow-sm">
                <p className="text-sm font-medium text-gray-600 dark:text-gray-400">Active</p>
                <p className="text-2xl font-bold text-blue-600">{systemStatus?.machines.active || 0}</p>
              </div>
              <div className="bg-white dark:bg-slate-800 rounded-lg p-6 shadow-sm">
                <p className="text-sm font-medium text-gray-600 dark:text-gray-400">Offline</p>
                <p className="text-2xl font-bold text-red-600">{systemStatus?.machines.offline || 0}</p>
              </div>
            </div>
          )}
        </div>
        ...
        <div className="mb-8">
          <h2 className="text-xl font-semibold text-gray-900 dark:text-white mb-4">Role-Based Dashboards</h2>
              ...
              return (
                ...
                >
                  <div className="flex items-start space-x-4">
                    <div className={`p-3 rounded-lg ${role.color} transition-colors duration-200`}>
